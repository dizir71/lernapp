...
function saveResult(res){
  const history = JSON.parse(localStorage.getItem("bwl_results")||"[]");
  history.push(res);
  localStorage.setItem("bwl_results",JSON.stringify(history));
}
function loadHistory(){ return JSON.parse(localStorage.getItem("bwl_results")||"[]"); }
